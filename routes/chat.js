...
exports.start = function(sockets){
  ...
  var ot = new opentok.OpenTokSDK(process.env.OPENTOK_KEY, process.env.OPENTOK_TOKEN, {API_URL: 'https://api.opentok.com/hl' });
  ...
  sockets.on('connection', function(socket) {
    ...
    ot.createSession('labs.sovechkin.com', {}, function(session) {
